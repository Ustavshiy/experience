...
CREATE TABLE EMP (EMPNO NUMERIC(4), ENAME VARCHAR(10), JOB VARCHAR(9), MGR NUMERIC(4), HIREDATE date, SAL NUMERIC(7,2)
, COMM NUMERIC(7,2), DEPTNO NUMERIC(2), PRIMARY KEY (empno));
