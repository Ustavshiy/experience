...
public class PatientTestData {
    public static ArrayList<Patient> getPatientArrayList() {
        ...
        Patient patient1 = new Patient(5, patientPersonalInfo1, patientMedicalInfo1);
        ...
        Patient patient2 = new Patient(3, patientPersonalInfo2, patientMedicalInfo2);
        ...
        Patient patient3 = new Patient(2, patientPersonalInfo3, patientMedicalInfo3);
        ...
        Patient patient4 = new Patient(1, patientPersonalInfo4, patientMedicalInfo4);
        ...
        Patient patient5 = new Patient(4, patientPersonalInfo5, patientMedicalInfo5);
